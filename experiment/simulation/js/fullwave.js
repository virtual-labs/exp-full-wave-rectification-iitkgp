...
//        document.getElementById("fullps").value = 0;
...
function mainswt() {
    ...
    if (bttn == "Off") {
        ...
        document.getElementById("flrcps").value = 0;
        document.getElementById("phs2").value = 0;
        document.getElementById("fr").value = 1000;

        document.getElementById("vp").value = 0;
        document.getElementById("phase").value = 0;
        document.getElementById("flps").value = 0;
...
//---------------------------------------------------------Output Fullwave Rectifier--------------------------------------------------------------------//   
    ...
    tstop1 = tmaxs;
    // alert(tstop );
    dt1 = (tstop - tstart) / (101 - 1);
    //  alert(dt);// time increment over N points

    for (j = 0; j < axes.N; j++) {
        x1[j] = tstart1 + j * dt1;

        y1[j] = vps * Math.sin(2 * 3.1415 * fos * x1[j] + phss * 3.1415 / 180);      //       + parseInt(pos)               
    }
    //alert(x);
    // alert(y);
    // alert(z);
